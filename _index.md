...
- **LLM-friendly outputs** — `llms.txt`, `llms-full.txt`, and `sitemap.xml` are emitted on every build.
- **Inherited page metadata** — `topTitle`, parent titles, and back-links are walked up the directory tree automatically.
